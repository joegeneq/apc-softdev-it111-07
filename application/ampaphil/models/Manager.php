 ...
 * @property string $MGR_BlkOrAreaNo
...
class Manager extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['MGR_LName', 'MGR_FName', 'MGR_Gender', 'MGR_BDate', 'MGR_BlkOrAreaNo', 'MGR_Street', 'MGR_Brgy', 'MGR_City', 'MGR_ContactNo', 'MGR_EmailAdd', 'MGR_Expertise'], 'required'],
            [['MGR_BDate'], 'safe'],
            [['MGR_ZipCode'], 'integer'],
            [['MGR_LName', 'MGR_FName', 'MGR_MName', 'MGR_Street', 'MGR_Brgy', 'MGR_City', 'MGR_EmailAdd'], 'string', 'max' => 45],
            [['MGR_Gender', 'MGR_BlkOrAreaNo'], 'string', 'max' => 10],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'MGR_BDate' => 'Mgr  Bdate',
            'MGR_BlkOrAreaNo' => 'Mgr  Blk Or Area No',
